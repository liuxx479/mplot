...
peaks_mat_dir_45sim = '/Users/jia/magbias/peaks_mat_noise_sim45_mask/'
peaks_mat_dir_5sim = '/Users/jia/magbias/peaks_mat_noise_mask/'
...
#show()
#figtext(.02, .02, description)
savefig(plot_dir+dNtitle+'bins%s_Fisher_omsi_diag.jpg'%(bins))
close()
################################
